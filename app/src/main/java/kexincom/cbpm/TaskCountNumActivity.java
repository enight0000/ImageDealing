...
public class TaskCountNumActivity extends ActionBarActivity implements ImageListFragment.ImageListCallbacks{
    public String URL = "http://rmb-app.com:8881/game/";//"http://image.baidu.com/pictureup/uploadshitu"
    public String KEY = "headImg";
    public String NAME = "应用：数数";
    public Map<String, String> PARAMS = new HashMap<String, String>();
    public boolean albumFlag = false;
    ...
    public void onClickListener(int action, Image image) {
        switch (action) {
            case ImageListFragment.ImageListCallbacks.OPENALBUM:
                imageListFragment = ImageListFragment.newInstance(albumFlag);
                albumFlag = !albumFlag;
                fragmentManager.beginTransaction()
                        .replace(R.id.Task_count_main, imageListFragment)
                        .commit();
    ...
    private void callCamera() {
        Intent i = new Intent(TaskCountNumActivity.this, CameraActivity.class);
